...
class Street_t
{
    public:
        ...
        Street_t<SID, BID>& operator=(const Street_t& s);
...
template <class SID, class BID>
const SID& Street_t<SID, BID>::getStreetID() const {return id;}

template <class SID, class BID>
void Street_t<SID, BID>::setStreetID(const SID& newID) {id = newID;}
